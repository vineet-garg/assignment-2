...
public class ServerResourceTest {
	...
	@Test
	public void testPushAndRecalculate_avg()
	...
	@Test
	public void testPushAndRecalculate_sd()
			throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException {
		StatsSvc statsSvc = new StatsSvcImpl();
		KeyGenerator keyGenerator = KeyGenerator.getInstance("AES");
		keyGenerator.init(256);
	...
	@Test
	public void testPushRecalculateAndEncrypt_Decrypt_sd()
			throws EncryptionSvcException, NoSuchAlgorithmException, InvalidKeyException {
		StatsSvc statsSvc = new StatsSvcImpl();
		KeyGenerator keyGenerator = KeyGenerator.getInstance("AES");
		keyGenerator.init(256);
		SecretKey key = keyGenerator.generateKey();
	...
	@Test
	public void testPushRecalculateAndEncrypt_Decrypt_avg()
			throws InvalidKeyException, IllegalBlockSizeException, BadPaddingException, NoSuchAlgorithmException,
			NoSuchPaddingException, InvalidAlgorithmParameterException, EncryptionSvcException {
		StatsSvc statsSvc = new StatsSvcImpl();
		KeyGenerator keyGenerator = KeyGenerator.getInstance("AES");
		keyGenerator.init(256);
		SecretKey key = keyGenerator.generateKey();
